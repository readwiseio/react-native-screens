...
const ReanimatedNativeStackScreen = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const sheetProgress = (0, _reactNativeReanimated.useSharedValue)(_reactNative.Platform.OS === 'ios' ? 0 : 1);
  return /*#__PURE__*/_react.default.createElement(AnimatedScreen
  // @ts-ignore some problems with ref and onTransitionProgressReanimated being "fake" prop for parsing of `useEvent` return value
  , _extends({
    ref: ref,
    onSheetProgressReanimated: (0, _reactNativeReanimated.useEvent)(event => {
      'worklet';

      sheetProgress.value = event.progress;
    }, [
    // @ts-ignore wrong type
    _reactNative.Platform.OS === 'android' ? 'onSheetProgress' : ENABLE_FABRIC ? 'onSheetProgress' : 'topSheetProgress']),
  ...
  }, /*#__PURE__*/_react.default.createElement(_ReanimatedSheetProgressContext.default.Provider, {
    value: sheetProgress
  }, children))));
});
