...
const ReanimatedNativeStackScreen = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  , _extends({
    ref: ref,
    onSheetProgressReanimated: useEvent(event => {
      'worklet';

      sheetProgress.value = event.progress;
    }, [
    // @ts-ignore wrong type
    Platform.OS === 'android' ? 'onSheetProgress' : ENABLE_FABRIC ? 'onSheetProgress' : 'topSheetProgress']),
  ...
  }, /*#__PURE__*/React.createElement(ReanimatedSheetProgressContext.Provider, {
    value: sheetProgress
  }, children))));
});
